...
import org.fbi.hmfsjz.online.service.Txn0711Service;
...
public class T0711Processor extends AbstractTxnProcessor {
    ...
    protected void doRequest(Stdp10ProcessorRequest request, Stdp10ProcessorResponse response) throws ProcessorException, IOException {
        ...
        logger.info("[1500711][2001][hmfsjz 缴款书缴款确认][网点号]" + branchID + "[柜员号]" + tellerID
                + "  [缴款书编号] " + billNo);
        ...
        try {
            ...
            Toa2001 toa = (Toa2001) new Txn0711Service().process(tellerID, branchID, serialNo, billNo, txnDate);
            ...
            logger.error("[1500711][2001][hmfsjz 缴款单缴款确认]失败", e);
